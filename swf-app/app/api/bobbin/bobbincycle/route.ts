...
/**
 * GET /api/bobbin/bobbincycle?code=<scanned bobbin code>
 * Proxies to swf-api /bobbin/bobbincycle?lc_cd=… only; swf-api applies fixed company/factory/lang.
 */
export async function GET(req: NextRequest) {
    ...
    const url = `${baseUrl()}/bobbin/bobbincycle?${params.toString()}`;
