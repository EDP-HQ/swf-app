...
/** Proxies POST /bobbin/limitwarning → swf-api (sp_Bobbin_Limit_Warning_Update). */
export async function POST(req: NextRequest) {
    ...
    const url = `${baseUrl()}/bobbin/limitwarning`;
    let res: Response;
    try {
        res = await fetch(url, {
            method: 'POST',
...
/** Proxies GET /bobbin/limitwarning → swf-api (sp_Bobbin_Limit_Warning_Select). */
