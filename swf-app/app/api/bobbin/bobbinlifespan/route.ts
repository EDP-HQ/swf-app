...
/**
 * GET /api/bobbin/bobbinlifespan?lc_cd=4977
 * Proxies to swf-api /bobbin/bobbinlifespan.
 */
export async function GET(req: NextRequest) {
    ...
    const url = `${baseUrl()}/bobbin/bobbinlifespan?${new URLSearchParams({ lc_cd: lcCd.trim() }).toString()}`;
