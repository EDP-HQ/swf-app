...
const SUBMENU_TRANSITION_MS = { enter: 220, exit: 220 };

const AppMenuitem = memo(function AppMenuitem(props: AppMenuItemProps) {
    ...
    const subMenu = item!.items && item!.visible !== false && (
        <CSSTransition
            timeout={{ enter: SUBMENU_TRANSITION_MS.enter, exit: SUBMENU_TRANSITION_MS.exit }}
